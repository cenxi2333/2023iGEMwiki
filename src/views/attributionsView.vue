<template>
    <div class="attributions">
        ...
        <hr>
        <div class="SmallTitle">Work Distribution</div>
         <div class="BigContainer ">
            <div class="options" v-for="item in productions" v-bind:key="item" >
                <p class="Name">{{ item.Name }}({{ item.Role }})</p>
                <p>General Tasks:{{ item.GeneralTasks }}</p>
                <p class="LastOne">Specific Tasks:{{ item.SpecificTasks }}</p>
                <hr>
            </div> 
         </div>
         <div class="SmallTitle">External Contributions</div>
         <div class="BigContainer">
            <div class="options" v-for="person in persons" v-bind:key="person" >
                <p class="Name">{{ person.Name }}</p>
                <p>Institution Type:{{ person.InstitutionType }}</p>
                <p>Relationship to team:{{ person.RelationshipToTeam }}</p>
                <p>General Tasks:{{ person.GeneralTasks }}</p>
                <p class="LastOne">Specific Tasks:{{ person.SpecificTasks }}</p>
                <hr>
            </div> 
         </div>
    </div>
